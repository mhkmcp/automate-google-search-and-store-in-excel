...
def get_hotel_data():
    ...
    for dst in all_districts:
        try:
            WEBSITE_URL = "https://www.google.com/search?query=hotel+resort+{}".format(dst)
            print(WEBSITE_URL)
            ...
            for restaurant in restaurants:
                ...
                if rating >= 4.3 and reviews > 80 or stars == 3:
                    ws.write(row_count, 7, "Ultra High")
                elif rating < 3.8 and reviews >= 50 or stars >= 2:
                    ws.write(row_count, 7, "High")
                elif rating >= 3.4 and reviews > 20:
    ...
    wb.save("hotel_list_demo.xls")
    print('Total Hotels: ', restaurant_count)
